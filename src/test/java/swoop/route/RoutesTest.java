...
public class RoutesTest {
    ...
    private static RouteMatch<FilterAwareImpl> newRouteMatchMock(boolean isFilter) {
        ...
        VerbMatcher verbMatcher = mock(VerbMatcher.class);
        PathPatternMatcher pathMatcher = mock(PathPatternMatcher.class);
        RouteEntry<FilterAwareImpl> entry = RouteEntry.create(verbMatcher, pathMatcher, new FilterAwareImpl(isFilter));
